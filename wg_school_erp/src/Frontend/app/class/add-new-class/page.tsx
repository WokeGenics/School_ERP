...
import AddClassScheduleForm from '../../components/class/AddClassScheduleForm';
...
export default function AddClassSchedulePage() {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen text-black">
      <h1 className="text-2xl font-bold mb-6">Add Class Schedule</h1>
      {successMessage && (
        <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-4">
          {successMessage}
        </div>
      )}
      <AddClassScheduleForm onFormSubmit={handleFormSubmission} />
    </div>
  );
}
